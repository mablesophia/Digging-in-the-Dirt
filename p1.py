...
#                 in a directory and tak action on some particular files
##########################################################################################################
    ...
    while True:
        ...
        if len(search_input.split()) == 1:
            ...
            if command == 'N':
                ...
                narrow_search_result=cmd_T(pattern,  search_result)
                for i in narrow_search_result:
                    print(i)
                break
            elif command == '<':
    ...
    while True:
        ...
        if len(narrow_search_input.split()) == 1:
            if narrow_search_input not in command_valid_list:
                ...
                cmd_Dup(narrow_search_result, input_path)
                break
...
def cmd_T(pattern, search_result):
